...
% Tema Copenhagen - mais limpo que Madrid mas ainda profissional
\usetheme{Copenhagen}
\usecolortheme{beaver} % Tons de vermelho/marrom mais sutis
\setbeamertemplate{navigation symbols}{}

% Cores personalizadas UFRJ (mais sutis)
\definecolor{ufrjblue}{RGB}{0,53,96}
\definecolor{ufrjlightblue}{RGB}{51,102,153}
\definecolor{ufrjgray}{RGB}{100,100,100}

% Aplicar cores com moderação
\setbeamercolor{structure}{fg=ufrjblue}
\setbeamercolor{frametitle}{bg=ufrjblue!10,fg=ufrjblue}
\setbeamercolor{block title}{bg=ufrjblue,fg=white}
\setbeamercolor{block body}{bg=ufrjblue!5}

% Remover apenas as sombras mais pesadas
